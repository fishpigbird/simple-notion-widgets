!function(e, t) {
    ...
    , function(e, t, n) {
        ...
        n(6);
        var i, a = n(8), r = (i = a) && i.__esModule ? i : {
            default: i
        };
        ...
        var m = []
          , g = function() {
            function e(t) {
                ...
                this.options.darkMode && this.setDarkMode(!0),
                this.options.lrcType && (this.lrc = new p.default({
                    container: this.template.lrc,
                    async: 3 === this.options.lrcType,
                    player: this,
                    external: !0 === this.options.lrcExternal,
                    offset: this.options.lrcOffset || -.15
                }),
                this.options.hideLrc && this.lrc.hide()),
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    this.on("error", function() {
                        ...
                        t = setTimeout(function() {
                            e.skipForward(),
                            e.paused || e.play()
                        }, 2e6)) : 1 === e.list.audios.length && e.notice("An audio error has occurred.")
                    }),
                ...
                value: function() {
                    ...
                    n && this.list.audios[t] && (this.list.audios[t].theme = e),
                ...
                value: function() {
                    ...
                    this.darkMode = e,
                    e ? this.container.classList.add("aplayer-dark") : this.container.classList.remove("aplayer-dark")
                }
            }, {
                key: "notice",
                value: function(e) {
    ...
    , function(e, t, n) {
        ...
        (function(e) {
            ...
            function c(e, t) {
                ...
                u._immediateFn(function() {
                    ...
                    if (null !== n) {
                        ...
                        (1 === e._state ? p : d)(t.promise, e._value)
                })) : e._deferreds.push(t)
            }
            function p(e, t) {
                try {
            ...
            u.prototype.then = function(e, t) {
                ...
                return c(this, new y(e,t,n)),
                n
            }
            ,
            u.prototype.finally = o.default,
            u.all = function(e) {
    ...
    , function(e, t, n) {
        ...
        t.default = function(e) {
            var t = {
                ...
                volume: .7,
                listFolded: e.fixed,
                listMaxHeight: e.listmaxheight || 250,
                audio: e.music || [],
                storageName: "aplayer-setting"
            };
            for (var n in t)
                t.hasOwnProperty(n) && !e.hasOwnProperty(n) && (e[n] = t[n]);
            return e.listMaxHeight = parseFloat(e.listMaxHeight),
    ...
    , function(e, t, n) {
        ...
        var s = function() {
            function e(t) {
                ...
                this.current = [],
                this.visible = !0,
                this.external && this.player.template.lrcWrap.classList.add("aplayer-lrc-hide")
            }
            return a(e, [{
                key: "show",
                value: function() {
                    ...
                    this.visibie = !0,
                    this.external || this.player.template.lrcWrap.classList.remove("aplayer-lrc-hide")
                }
            }, {
                key: "hide",
                value: function() {
                ...
                value: function() {
                    ...
                    if (this.index > this.current.length - 1 || e < this.current[this.index][0] || this.current[this.index + 1] && e >= this.current[this.index + 1][0])
                        for (var t = 0; t < this.current.length; t++)
                            ...
                            this.external || (this.player.events.trigger("lrcchange", this.current[this.index]),
                            ...
                            if (r)
                                for (var s = r.length, l = 0; l < s; l++) {
                                    var u = /\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/.exec(r[l])
                                      ...
                                      , h = Math.max(0, c + p + d + this.offset);
                                    n.push([h, o])
                                }
                        }
            ...
            return i(e, [{
                ...
                value: function() {
                    var e = this
                      ...
                      , n = function n(i) {
                        ...
                        e.player.seek(r * e.player.duration),
                ...
                value: function() {
                    ...
                    this.player.template.volumeButton.addEventListener("click", function() {
                        e.player.audio.muted ? e.player.volume(e.player.audio.volume, !0) : (e.player.audio.muted = !0,
                ...
                value: function() {
                    ...
                    this.player.events.on("lrcshow", function() {
                        e.player.template.lrcButton.classList.remove("aplayer-icon-lrc-inactivity")
                    }),
                    this.player.events.on("lrchide", function() {
    ...
    , function(e, t, n) {
        ...
        var a = function() {
            function e() {
                ...
                this.playerEvents = ["destroy", "listshow", "listhide", "listadd", "listremove", "listswitch", "listclear", "noticeshow", "noticehide", "lrcshow", "lrchide", "lrcchange"]
            }
            return i(e, [{
                key: "on",
                value: function(e, t) {
    ...
    , function(e, t, n) {
        ...
        var l = function() {
            ...
            return i(e, [{
                ...
                value: function() {
                    this.showing = !0,
                    this.player.template.list.scrollTop = 33 * this.index,
                    this.player.template.list.style.height = Math.min(this.player.template.list.scrollHeight, this.player.options.listMaxHeight) + "px",
                ...
                value: function() {
                    ...
                    this.player.template.list.style.height = Math.min(this.player.template.list.scrollHeight, this.player.options.listMaxHeight) + "px",
                    setTimeout(function() {
                        e.player.template.list.style.height = "0px",
                        e.player.events.trigger("listhide")
                    }, 0)
                }
            }, {
                key: "toggle",
                ...
                value: function(e) {
                    ...
                    this.player.template.list.innerHTML += (0,
                    a.default)({
                ...
                value: function(e) {
                    ...
                    void 0 !== e && this.audios[e]) {
                        ...
                        (0,
                        o.default)(33 * this.index, 500, null, this.player.template.list),
